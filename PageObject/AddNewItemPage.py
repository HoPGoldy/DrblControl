...
class AddNewItemPage(BasePage):
    ...
    #亮点选择框以及添加按钮
    _longHightLightAddButtonLoc = (By.CSS_SELECTOR, '#FORTUNATELY_div > div:nth-child(1) > div')
    ...
    def addLongHighLightNum(self, highLightNum):
        longHighLightAddButton = self.findElement(self._longHightLightAddButtonLoc)
